 ...
 * Forked from https://github.com/arcadeum/multi-token-standard
 */
contract ERC1155 is IERC1155 {
  ...
  function balanceOf(address _owner, uint256 _id)
    virtual public override view returns (uint256)
  {
  ...
  function balanceOfBatch(address[] memory _owners, uint256[] memory _ids)
    virtual public override view returns (uint256[] memory)
  {
